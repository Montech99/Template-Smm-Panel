...
if (isset($_POST['ganti_pass'])) {
	...
	if (!$password || !$password_baru || !$konfirmasi_baru) {
    		...
    		$_SESSION['hasil'] = array('alert' => 'danger', 'judul' => 'Gagal', 'pesan' => 'Password Baru Minimal 6 Karakter');
...
?>  
            ...
            <div class="row">
              <div class="col-8 col-sm-12 col-xl-8 my-auto">
                <div class="d-flex d-sm-block d-md-flex align-items-center">
                  <h2 class="mb-0">Rp <?php echo number_format($data_user['saldo'], 0, ',', '.'); ?></h2>
                </div>
              </div>
              <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                <i class="icon-lg mdi mdi mdi-bank text-info ml-auto"></i>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-8 col-sm-12 col-xl-8 my-auto">
                <div class="d-flex d-sm-block d-md-flex align-items-center">
                  <h2 class="mb-0">Rp <?php echo number_format($data_order_sosmed['total'], 0, ',', '.'); ?></h2>
                  <p class="text-success ml-2 mb-0 font-weight-medium">(<?php echo $jumlah_order_sosmed; ?>)</p>
                </div>
              </div>
              <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-8 col-sm-12 col-xl-8 my-auto">
                <div class="d-flex d-sm-block d-md-flex align-items-center">
                  <h2 class="mb-0">Rp <?php echo number_format($data_deposit_user['total'], 0, ',', '.'); ?></h2>
                  <p class="text-primary ml-2 mb-0 font-weight-medium">(<?php echo $jumlah_deposit_user; ?>) </p>
                </div>
              </div>
              <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                <i class="icon-lg mdi mdi mdi-briefcase-download text-primary ml-auto"></i>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="m-t-0 text-center header-title">Pengaturan Profil</h4>
                    <hr>
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><b class="badge badge-info"><?php echo $data_user['level']; ?></b></td>
                            </tr>
                            <tr>
                    ...
                    <div class="tab-content">
                            ...
                            <form class="form-horizontal" method="POST">
                                ...
                                <div class="form-group row m-b-0">
                                    <div class="offset-sm-3 col-sm-9">
                                        <button type="submit" name="ganti_pass" class="btn btn-block btn-info waves-effect waves-light"><i class="mdi mdi-check-all"></i> Ganti Password</button>
                        ...
                        <div class="tab-pane" id="nama" role="nama" aria-labelledby="nama-tab">
                            <form class="form-horizontal" method="POST">
                                ...
                                ?>
                                    ...
                                    <div class="form-group row m-b-0">
                                        <div class="offset-sm-3 col-sm-9">
                                            <button type="submit" name="setting_nama" class="btn btn-block btn-info waves-effect waves-light" <?php echo $disabled; ?>><i class="mdi mdi-check-all"></i> Ganti Nama</button>
                        ...
                        <div class="tab-pane" id="email" role="email" aria-labelledby="email-tab">
                            <form class="form-horizontal" method="POST">
                                ...
                                ?>
                                    ...
                                    <div class="form-group row m-b-0">
                                        <div class="offset-sm-3 col-sm-9">
                                            <button type="submit" name="setting_email" class="btn btn-block btn-info waves-effect waves-light" <?php echo $disabled; ?>><i class="mdi mdi-check-all"></i> Ganti Email</button>
                        ...
                        <div class="tab-pane" id="nomer" role="nomer" aria-labelledby="nomer-tab">
                            <form class="form-horizontal" method="POST">
                                ...
                                ?>
                                    ...
                                    <div class="form-group row m-b-0">
                                        <div class="offset-sm-3 col-sm-9">
                                            <button type="submit" name="setting_nomer" class="btn btn-block btn-info waves-effect waves-light" <?php echo $disabled; ?>><i class="mdi mdi-check-all"></i> Ganti No Hp</button>
                        ...
                        <div class="tab-pane" id="api" role="api" aria-labelledby="api-tab">
                            <form class="form-horizontal" method="POST">
                                ...
                                <div class="form-group row m-b-0">
                                    <div class="offset-sm-3 col-sm-9">
                                        <button type="submit" name="ganti_apinya" class="btn btn-block btn-info waves-effect waves-light"><i class="mdi mdi-shuffle-variant"></i> Update</button>
                                    </div>
                                </div>
                            </form>
                        </div>
