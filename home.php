...
<head>
    ...
    <title>SMM PANEL SEWA ZAYNFLAZZ</title>
    <meta name="keywords" content="smm panel,best smm panel,top smm panel,cheapest smm panel,facebook smm panel,facebook servcies,youtube smm panel,watch hours smm panel,youtube services,tiktok services,tiktok smm panel,cheap smm panel,promoteing smm panel,main smm panel,instagram smm panel,main smm provider,best smm provider">
    <meta name="description" content="Get the best and cheapest SMM Panel. Top reseller panel with worldwide SMM services for Instagram, YouTube, TikTok, Facebook, Telegram and Twitter services.">

    <meta name="google-site-verification" content="" />

    <!--ICON LOGO-->
    <link rel="shortcut icon" type="image/ico" href="https://zaynflazz.com/smmpanel/img/logo-zaynflazz-full-size/favicon.ico" />
    <link rel="icon" type="image/png" sizes="192x192" href="https://zaynflazz.com/smmpanel/img/logo-zaynflazz-full-size/android-chrome-192x192.png" />
    <link rel="icon" type="image/png" sizes="512x512" href="https://zaynflazz.com/smmpanel/img/logo-zaynflazz-full-size/android-chrome-512x512.png" />
    <link rel="icon" type="image/png" sizes="32x32" href="https://zaynflazz.com/smmpanel/img/logo-zaynflazz-full-size/favicon-32x32.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="https://zaynflazz.com/smmpanel/img/logo-zaynflazz-full-size/favicon-16x16.png" />
    <link rel="apple-touch-icon" href="https://zaynflazz.com/smmpanel/img/logo-zaynflazz-full-size/apple-touch-icon.png" />
    <!--END ICON LOGO-->
...
<body class="body  body-public">
                                    ...
                                    <div class="navbar-public__header">
                                        <div class="sidebar-block__top-brand">
                                            <div class="component-navbar-logo">
                                                <a href="/">
                                                    <img src="https://zaynflazz.com/smmpanel/assets/img/zaynflazz-golden.png" class="sidebar-block__top-logo" alt="Smm Panel Indonesia" title="smmapro">
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex flex-wrap component-navbar-collapse">
                                            <ul class="navbar-nav">
                                                <li class="nav-item component-navbar-nav-item component-navbar-public-nav-item nav-item-height">
                                                    <a class="component-navbar-nav-link component-navbar-nav-link__navbar-public component-navbar-nav-link-active__navbar-public" href="/"><i class="navbar-icon fas fa-sign-in-alt"></i> Masuk</a>
                                                </li>
                                                <li class="nav-item component-navbar-nav-item component-navbar-public-nav-item nav-item-height">
                                                    <a class="component-navbar-nav-link component-navbar-nav-link__navbar-public " href="/"><i class="navbar-icon fas fa-ballot"></i> Layanan</a>
                                                </li>
                                                <li class="nav-item component-navbar-nav-item component-navbar-public-nav-item nav-item-height">
                                                    <a class="component-navbar-nav-link component-navbar-nav-link__navbar-public " href="/"><i class="navbar-icon fab fa-autoprefixer"></i> API</a>
                                                </li>
                                                <li class="nav-item component-navbar-nav-item component-navbar-public-nav-item nav-item-height">
                                                    <a class="component-navbar-nav-link component-navbar-nav-link__navbar-public " href="/"><i class="navbar-icon fad fa-user-alt"></i> Daftar</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="block-signin__content">
                                        ...
                                        <div class="block-signin__description style-text-signin">
                                            <p class="text-center"><span style="color: var(--color-id-231)"><span style="text-align: CENTER">Pusat Reseller Sosial Media Marketing Termurah & Berkualitas!</span></span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="custom-col">
                                                        <div class="form-group d-flex justify-content-center ">
                                                            <div class="block-signin__remember">
                                                                ...
                                                                <a class="block-signin__link" href="/">Daftar</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="text-block__title">
                                        <h2 class="text-center">Kenapa Harus Di <b style="color:#edd921;">Zaynflazz Sewa Smm</b></h2>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="text-block__description">
                                        <p class="text-center">4 Alasan Kenapa Kamu Harus Memilih Zaynflazz Sewa Smm.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="integration-fixed integration-fixed__bottom-left">
        <div class="whatsapp-container">
            <a href="https://api.whatsapp.com/send?phone=201023619662" target="_blank" class="whatsapp-button">
                <i class="fab fa-whatsapp"></i>
            </a>
        </div>
    </div>
    <script type="text/javascript" src="/landing/assets/js/y1wwkk54c30uypmy.js">
    </script>
    <script type="text/javascript" src="/landing/assets/js/5sj057uwzy9m8fjz.js">
    </script>
    <script type="text/javascript" src="/landing/assets/js/5xxni99jbnx8d3t5.js">
    </script>
</body>
