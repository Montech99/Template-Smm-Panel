                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['cari'])) {
                                    ...
                                    $cek_pesanan = "SELECT * FROM history_saldo WHERE date LIKE '%$cari_oid%' AND aksi LIKE '%$cari_status%' ORDER BY id DESC"; // edit
                                } else {
                                    $cek_pesanan = "SELECT * FROM history_saldo ORDER BY id DESC"; // edit
                                }
                                if (isset($_GET['cari'])) {
