                ...
                <form class="form-horizontal" role="form" method="POST">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-box">
                            <tr>
                                <th class="table-detail" width="50%">ID USERS</th>
                                <td class="table-detail"><?php echo $data_pengguna['id']; ?></td>
                            </tr>
                            <tr>
                                <th class="table-detail">NAMA</th>
                                <td class="table-detail">
                                    <div class="text-primary"><?php echo $data_pengguna['nama']; ?></div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="table-detail"><span>
                                        <div class="badge badge-<?php echo $label; ?>"><?php echo $data_pengguna['status']; ?></div>
                                    </span></td>
                            </tr>
                            <tr>
                                <th class="table-detail">PHONE</th>
                                <td class="table-detail"><?php echo $data_pengguna['nomer']; ?></td>
                            </tr>
                        </table>
                    </div>
