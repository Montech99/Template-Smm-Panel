        ...
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" role="form" method="POST">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Pesan Tiket</label>
                        <div class="col-sm-9">
                        <textarea style="background: #000;" class="form-control"rows="4" disabled><?php echo $ThisData['pesan']; ?></textarea>
                        </div>
                    </div>
                    
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-info waves-effect w-md waves-light" name="tutup">Tutup Tiket</button>
                    </div>
                </form>
            </div>
        </div>
