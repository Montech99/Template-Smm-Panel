            ...
            <table class="table table-striped table-bordered table-box">
                ...
                <tr>
                    ...
                    <td class="table-detail">
                        <badge class="badge badge-<?php echo $badge; ?>"><?php echo $data_pesanan['status']; ?>
                    </td>
                </tr>
                <tr>
                    <th class="table-detail">Tanggal & Waktu</th>
                    <td class="table-detail"><?php echo tanggal_indo($data_pesanan['date']); ?>, <?php echo $data_pesanan['time']; ?> WIB</td>
                </tr>
                <tr>
                    <th class="table-detail">Refund / Pengembalian Dana</th>
                    <td class="table-detail"><?php echo $icon2; ?></td>
                </tr>
                <tr>
                    <th class="table-detail">Via</th>
                    <td class="table-detail"><?php echo $icon; ?></td>
                </tr>
            </table>
        </div>
<?php
