                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <badge class="badge badge-outline-<?php echo $badge; ?>"><?php echo $data_pesanan['status']; ?></badge>
                                        </td>
                                        <td>
                                            <?php
                                            if ($data_pesanan['refill'] == "YA") {
                                            ?>
                                                <a href="<?php echo $config['web']['url']; ?>halaman/refill-order?id=<?php echo $data_pesanan['id']; ?>" class="btn btn-sm btn-info">Refill</a>
                                            <?php
                                            } else {
                                            ?>
                                        ...
                                        <td><button class="view_order btn btn-dark" data-toggle="modal" id="<?php echo $data_pesanan['id']; ?>" data-target='#myDetail'><i class="mdi mdi-magnify"></i></button>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
